...
insert into T_INTERVAL(id, time_id) values (50, TO_DATE('01-02-2008', 'DD-MM-YYYY'));
INSERT INTO T_INTERVAL(id, time_id)
VALUES (105, TO_DATE('01-01-2009', 'DD-MM-YYYY'));

INSERT INTO T_INTERVAL(id, time_id)
VALUES (105, TO_DATE('01-01-2007', 'DD-MM-YYYY'));

INSERT INTO T_INTERVAL(id, time_id)
VALUES (205, TO_DATE('01-01-2019', 'DD-MM-YYYY'));

INSERT INTO T_INTERVAL(id, time_id)
VALUES (305, TO_DATE('01-01-2013', 'DD-MM-YYYY'));

INSERT INTO T_INTERVAL(id, time_id)
VALUES (405, TO_DATE('01-01-2017', 'DD-MM-YYYY'));

INSERT INTO T_INTERVAL(id, time_id)
VALUES (505, TO_DATE('01-01-2022', 'DD-MM-YYYY'));
