...
int main()
{
	...
	LPCWSTR path = L"D:\\Labs\\Course 3\\Term 1\\Operating Systems\\07\\Lab07\\Lab07\\Lab07\\x64\\Debug\\OS07_04x.exe";
	...
	CloseHandle(htimer);
	cout << "Elapsed time = " << (clock() - start) << " s" << endl;
	system("pause");
	return 0;
}