...
namespace Client
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            StudentsEntities1 service = new StudentsEntities1(new Uri("http://localhost:1395/Service1.svc"));

            foreach (var s in service.students.AsEnumerable())
            {
                this.listBox1.Items.Add(s.id.ToString() + " " + s.name);
            }
            foreach (var s in service.notes.AsEnumerable())
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (id != -1)
                {
                    ...
                    var student = service.students.AsEnumerable().First(i => i.id == idstudent);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (textBox4.Text != "")
            {
                try
                {
                    ...
                    foreach (var n in service.notes.AsEnumerable())
                    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (id != -1)
                {
                    ...
                    var note = service.notes.AsEnumerable().First(i => i.id == idnote);
